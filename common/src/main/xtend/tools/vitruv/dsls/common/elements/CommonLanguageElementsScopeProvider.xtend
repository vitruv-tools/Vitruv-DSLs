...
class CommonLanguageElementsScopeProvider {
	 ...
	 */
	def createQualifiedEClassifierScope(MetamodelImport metamodelImport) {
		return createQualifiedEClassifierScope(metamodelImport, false, null, EcorePackage.Literals.EOBJECT);
	}
	...
	def createQualifiedEClassScopeWithEObject(MetamodelImport metamodelImport) {
		return createQualifiedEClassifierScope(metamodelImport, true, null, EcorePackage.Literals.EOBJECT);
	}
	...
	def createQualifiedEClassScopeWithoutAbstract(MetamodelImport metamodelImport) {
		return createQualifiedEClassifierScope(metamodelImport, false, [if(it instanceof EClass)!abstract
			else false
	 ...
	 */
	private def createQualifiedEClassifierScope(MetamodelImport metamodelImport, boolean includeEObject,
