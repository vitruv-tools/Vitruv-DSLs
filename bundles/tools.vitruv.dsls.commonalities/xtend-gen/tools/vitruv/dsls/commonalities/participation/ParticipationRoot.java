...
public class ParticipationRoot {
  /**
  ...
  private final Set<CommonalityReferenceMapping> referenceMappings = new LinkedHashSet<CommonalityReferenceMapping>();
   ...
   */
  @Accessors(AccessorType.PUBLIC_GETTER)
  private final Set<ParticipationClass> classes = new LinkedHashSet<ParticipationClass>();

  /**
   * Containment relationships within the root itself.
   */
  @Accessors(AccessorType.PUBLIC_GETTER)
  private final Set<Containment> rootContainments = new LinkedHashSet<Containment>();
   ...
   */
  @Accessors(AccessorType.PUBLIC_GETTER)
  private final Set<Containment> boundaryContainments = new LinkedHashSet<Containment>();

  @Accessors({ AccessorType.PACKAGE_SETTER, AccessorType.PUBLIC_GETTER })
  private ParticipationClass attributeReferenceRoot = null;

  @Accessors(AccessorType.PUBLIC_GETTER)
  private final Set<OperatorContainment> attributeReferenceContainments = new LinkedHashSet<OperatorContainment>();
  ...
  public boolean isRootClass(final ParticipationClass participationClass) {
    return this.classes.contains(participationClass);
  }
  ...
  public String toString() {
    ...
    b.add("referenceMappings", this.referenceMappings);
    b.add("classes", this.classes);
    b.add("rootContainments", this.rootContainments);
    b.add("boundaryContainments", this.boundaryContainments);
    b.add("attributeReferenceRoot", this.attributeReferenceRoot);
    b.add("attributeReferenceContainments", this.attributeReferenceContainments);
    return b.toString();
  }
  ...
  @Pure
  public Set<ParticipationClass> getClasses() {
    return this.classes;
  }

  @Pure
  public Set<Containment> getRootContainments() {
    return this.rootContainments;
  }

  @Pure
  public Set<Containment> getBoundaryContainments() {
    return this.boundaryContainments;
  }

  @Pure
  public ParticipationClass getAttributeReferenceRoot() {
    return this.attributeReferenceRoot;
  }

  void setAttributeReferenceRoot(final ParticipationClass attributeReferenceRoot) {
    this.attributeReferenceRoot = attributeReferenceRoot;
  }

  @Pure
  public Set<OperatorContainment> getAttributeReferenceContainments() {
    return this.attributeReferenceContainments;
  }
}
