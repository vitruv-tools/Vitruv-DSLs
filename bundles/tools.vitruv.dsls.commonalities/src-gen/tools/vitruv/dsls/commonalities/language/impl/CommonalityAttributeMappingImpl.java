...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Commonality Attribute Mapping</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.commonalities.language.impl.CommonalityAttributeMappingImpl#isReadAndWrite <em>Read And Write</em>}</li>
 *   <li>{@link tools.vitruv.dsls.commonalities.language.impl.CommonalityAttributeMappingImpl#isWrite <em>Write</em>}</li>
 *   <li>{@link tools.vitruv.dsls.commonalities.language.impl.CommonalityAttributeMappingImpl#isRead <em>Read</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommonalityAttributeMappingImpl extends MinimalEObjectImpl.Container implements CommonalityAttributeMapping
{
  /**
   ...
   * @generated
   */
  protected CommonalityAttributeMappingImpl()
  {
    super();
  }
  ...
  {
    return LanguagePackage.Literals.COMMONALITY_ATTRIBUTE_MAPPING;
  }
  ...
  public void setReadAndWrite(boolean newReadAndWrite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.COMMONALITY_ATTRIBUTE_MAPPING__READ_AND_WRITE, oldReadAndWrite, readAndWrite));
  }
  ...
  public void setWrite(boolean newWrite)
  {
    ...
    write = newWrite;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.COMMONALITY_ATTRIBUTE_MAPPING__WRITE, oldWrite, write));
  }
  ...
  public void setRead(boolean newRead)
  {
    ...
    read = newRead;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.COMMONALITY_ATTRIBUTE_MAPPING__READ, oldRead, read));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LanguagePackage.COMMONALITY_ATTRIBUTE_MAPPING__READ_AND_WRITE:
        return isReadAndWrite();
      case LanguagePackage.COMMONALITY_ATTRIBUTE_MAPPING__WRITE:
        return isWrite();
      case LanguagePackage.COMMONALITY_ATTRIBUTE_MAPPING__READ:
        return isRead();
    }
...
} //CommonalityAttributeMappingImpl
