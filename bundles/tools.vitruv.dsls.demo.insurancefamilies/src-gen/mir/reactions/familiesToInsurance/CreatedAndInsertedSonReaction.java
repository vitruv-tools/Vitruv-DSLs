...
public class CreatedAndInsertedSonReaction extends AbstractReaction {
  private InsertEReference<EObject> insertChange;

  public CreatedAndInsertedSonReaction(final Function<ReactionExecutionState, RoutinesFacade> routinesFacadeGenerator) {
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.familiesToInsurance.CreatedAndInsertedSonReaction.Call(executionState).updateModels(insertChange, affectedEObject, affectedFeature, newValue, index, routinesFacade);
  }
}
