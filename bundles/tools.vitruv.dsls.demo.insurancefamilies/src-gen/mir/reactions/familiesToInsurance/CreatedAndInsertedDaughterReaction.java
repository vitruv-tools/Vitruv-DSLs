...
public class CreatedAndInsertedDaughterReaction extends AbstractReaction {
  private InsertEReference<EObject> insertChange;

  public CreatedAndInsertedDaughterReaction(final Function<ReactionExecutionState, RoutinesFacade> routinesFacadeGenerator) {
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.familiesToInsurance.CreatedAndInsertedDaughterReaction.Call(executionState).updateModels(insertChange, affectedEObject, affectedFeature, newValue, index, routinesFacade);
  }
}
