...
public class ChangedGenderReaction extends AbstractReaction {
  ...
  private static class Call extends AbstractRoutine.Update {
    ...
    public void updateModels(final ReplaceSingleValuedEAttribute replaceChange, final InsuranceClient affectedEObject, final EAttribute affectedFeature, final Gender oldValue, final Gender newValue, @Extension final InsuranceToFamiliesRoutinesFacade _routinesFacade) {
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.insuranceToFamilies.ChangedGenderReaction.Call(executionState).updateModels(replaceChange, affectedEObject, affectedFeature, oldValue, newValue, routinesFacade);
  }
}
