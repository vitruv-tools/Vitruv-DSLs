...
public class InsertedClientReaction extends AbstractReaction {
  private InsertEReference<EObject> insertChange;

  public InsertedClientReaction(final Function<ReactionExecutionState, RoutinesFacade> routinesFacadeGenerator) {
  ...
  private static class Call extends AbstractRoutine.Update {
    ...
    public void updateModels(final InsertEReference insertChange, final InsuranceDatabase affectedEObject, final EReference affectedFeature, final InsuranceClient newValue, final int index, @Extension final InsuranceToPersonsRoutinesFacade _routinesFacade) {
      _routinesFacade.createPerson(newValue);
    }
  }
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.insuranceToPersons.InsertedClientReaction.Call(executionState).updateModels(insertChange, affectedEObject, affectedFeature, newValue, index, routinesFacade);
  }
}
