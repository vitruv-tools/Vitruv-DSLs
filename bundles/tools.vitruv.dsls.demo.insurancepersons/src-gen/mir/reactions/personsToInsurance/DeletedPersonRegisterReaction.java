...
public class DeletedPersonRegisterReaction extends AbstractReaction {
  ...
  private static class Call extends AbstractRoutine.Update {
    ...
    public void updateModels(final DeleteEObject deleteChange, final PersonRegister affectedEObject, @Extension final PersonsToInsuranceRoutinesFacade _routinesFacade) {
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.personsToInsurance.DeletedPersonRegisterReaction.Call(executionState).updateModels(deleteChange, affectedEObject, routinesFacade);
  }
}
