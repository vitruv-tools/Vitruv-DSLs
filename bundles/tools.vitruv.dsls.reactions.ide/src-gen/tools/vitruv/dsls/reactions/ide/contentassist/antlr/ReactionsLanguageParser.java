...
public class ReactionsLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ReactionsLanguageGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReactionsLanguageGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getReactionsSegmentAccess().getAlternatives_15(), "rule__ReactionsSegment__Alternatives_15");
			builder.put(grammarAccess.getTriggerAccess().getAlternatives_1(), "rule__Trigger__Alternatives_1");
			builder.put(grammarAccess.getConcreteModelChangeAccess().getAlternatives(), "rule__ConcreteModelChange__Alternatives");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getAlternatives_1(), "rule__ModelAttributeChange__Alternatives_1");
			builder.put(grammarAccess.getElementExistenceChangeTypeAccess().getAlternatives(), "rule__ElementExistenceChangeType__Alternatives");
			builder.put(grammarAccess.getElementUsageChangeTypeAccess().getAlternatives(), "rule__ElementUsageChangeType__Alternatives");
			builder.put(grammarAccess.getElementRootChangeTypeAccess().getAlternatives(), "rule__ElementRootChangeType__Alternatives");
			builder.put(grammarAccess.getElementInsertionChangeTypeAccess().getAlternatives(), "rule__ElementInsertionChangeType__Alternatives");
			builder.put(grammarAccess.getElementRemovalChangeTypeAccess().getAlternatives(), "rule__ElementRemovalChangeType__Alternatives");
			builder.put(grammarAccess.getElementChangeTypeAccess().getAlternatives(), "rule__ElementChangeType__Alternatives");
			builder.put(grammarAccess.getRoutineInputAccess().getAlternatives_2_0(), "rule__RoutineInput__Alternatives_2_0");
			builder.put(grammarAccess.getRoutineInputAccess().getAlternatives_2_1_1(), "rule__RoutineInput__Alternatives_2_1_1");
			builder.put(grammarAccess.getMatchStatementAccess().getAlternatives(), "rule__MatchStatement__Alternatives");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getAlternatives(), "rule__RetrieveOrRequireAbscenceOfModelElement__Alternatives");
			builder.put(grammarAccess.getRetrieveModelElementTypeStatementAccess().getAlternatives(), "rule__RetrieveModelElementTypeStatement__Alternatives");
			builder.put(grammarAccess.getRetrieveModelElementTypeStatementAccess().getAlternatives_0_1(), "rule__RetrieveModelElementTypeStatement__Alternatives_0_1");
			...
			builder.put(grammarAccess.getReactionsFileAccess().getGroup(), "rule__ReactionsFile__Group__0");
			...
			builder.put(grammarAccess.getReactionsSegmentAccess().getGroup(), "rule__ReactionsSegment__Group__0");
			builder.put(grammarAccess.getReactionsSegmentAccess().getGroup_8(), "rule__ReactionsSegment__Group_8__0");
			builder.put(grammarAccess.getReactionsSegmentAccess().getGroup_13(), "rule__ReactionsSegment__Group_13__0");
			builder.put(grammarAccess.getReactionsImportAccess().getGroup(), "rule__ReactionsImport__Group__0");
			builder.put(grammarAccess.getReactionsImportAccess().getGroup_3(), "rule__ReactionsImport__Group_3__0");
			builder.put(grammarAccess.getReactionAccess().getGroup(), "rule__Reaction__Group__0");
			builder.put(grammarAccess.getReactionAccess().getGroup_2(), "rule__Reaction__Group_2__0");
			builder.put(grammarAccess.getRoutineCallAccess().getGroup(), "rule__RoutineCall__Group__0");
			builder.put(grammarAccess.getTriggerAccess().getGroup(), "rule__Trigger__Group__0");
			builder.put(grammarAccess.getModelElementChangeAccess().getGroup(), "rule__ModelElementChange__Group__0");
			builder.put(grammarAccess.getModelElementChangeAccess().getGroup_4(), "rule__ModelElementChange__Group_4__0");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getGroup(), "rule__ModelAttributeChange__Group__0");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getGroup_1_0(), "rule__ModelAttributeChange__Group_1_0__0");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getGroup_1_1(), "rule__ModelAttributeChange__Group_1_1__0");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getGroup_1_2(), "rule__ModelAttributeChange__Group_1_2__0");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getGroup_3(), "rule__ModelAttributeChange__Group_3__0");
			builder.put(grammarAccess.getArbitraryModelChangeAccess().getGroup(), "rule__ArbitraryModelChange__Group__0");
			builder.put(grammarAccess.getArbitraryModelChangeAccess().getGroup_2(), "rule__ArbitraryModelChange__Group_2__0");
			builder.put(grammarAccess.getElementCreationChangeTypeAccess().getGroup(), "rule__ElementCreationChangeType__Group__0");
			builder.put(grammarAccess.getElementDeletionChangeTypeAccess().getGroup(), "rule__ElementDeletionChangeType__Group__0");
			builder.put(grammarAccess.getElementInsertionInListChangeTypeAccess().getGroup(), "rule__ElementInsertionInListChangeType__Group__0");
			builder.put(grammarAccess.getElementInsertionAsRootChangeTypeAccess().getGroup(), "rule__ElementInsertionAsRootChangeType__Group__0");
			builder.put(grammarAccess.getElementRemovalAsRootChangeTypeAccess().getGroup(), "rule__ElementRemovalAsRootChangeType__Group__0");
			builder.put(grammarAccess.getElementRemovalFromListChangeTypeAccess().getGroup(), "rule__ElementRemovalFromListChangeType__Group__0");
			builder.put(grammarAccess.getElementReplacementChangeTypeAccess().getGroup(), "rule__ElementReplacementChangeType__Group__0");
			builder.put(grammarAccess.getRoutineAccess().getGroup(), "rule__Routine__Group__0");
			builder.put(grammarAccess.getRoutineAccess().getGroup_2(), "rule__Routine__Group_2__0");
			builder.put(grammarAccess.getRoutineOverrideImportPathAccess().getGroup(), "rule__RoutineOverrideImportPath__Group__0");
			builder.put(grammarAccess.getRoutineOverrideImportPathAccess().getGroup_1(), "rule__RoutineOverrideImportPath__Group_1__0");
			builder.put(grammarAccess.getRoutineInputAccess().getGroup(), "rule__RoutineInput__Group__0");
			builder.put(grammarAccess.getRoutineInputAccess().getGroup_2(), "rule__RoutineInput__Group_2__0");
			builder.put(grammarAccess.getRoutineInputAccess().getGroup_2_0_1(), "rule__RoutineInput__Group_2_0_1__0");
			builder.put(grammarAccess.getRoutineInputAccess().getGroup_2_1(), "rule__RoutineInput__Group_2_1__0");
			builder.put(grammarAccess.getRoutineInputAccess().getGroup_2_1_1_1(), "rule__RoutineInput__Group_2_1_1_1__0");
			builder.put(grammarAccess.getMatchBlockAccess().getGroup(), "rule__MatchBlock__Group__0");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getGroup(), "rule__RequireAbscenceOfModelElement__Group__0");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getGroup_8(), "rule__RequireAbscenceOfModelElement__Group_8__0");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getGroup_9(), "rule__RequireAbscenceOfModelElement__Group_9__0");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getGroup(), "rule__RetrieveModelElement__Group__0");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getGroup_1(), "rule__RetrieveModelElement__Group_1__0");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getGroup_8(), "rule__RetrieveModelElement__Group_8__0");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getGroup_9(), "rule__RetrieveModelElement__Group_9__0");
			builder.put(grammarAccess.getRetrieveModelElementTypeStatementAccess().getGroup_0(), "rule__RetrieveModelElementTypeStatement__Group_0__0");
			builder.put(grammarAccess.getRetrieveModelElementTypeStatementAccess().getGroup_1(), "rule__RetrieveModelElementTypeStatement__Group_1__0");
			builder.put(grammarAccess.getMatchCheckStatementAccess().getGroup(), "rule__MatchCheckStatement__Group__0");
			builder.put(grammarAccess.getCreateBlockAccess().getGroup(), "rule__CreateBlock__Group__0");
			builder.put(grammarAccess.getCreateStatementAccess().getGroup(), "rule__CreateStatement__Group__0");
			builder.put(grammarAccess.getUpdateBlockAccess().getGroup(), "rule__UpdateBlock__Group__0");
			builder.put(grammarAccess.getMetaclassReferenceAccess().getGroup(), "rule__MetaclassReference__Group__0");
			builder.put(grammarAccess.getMetaclassReferenceAccess().getGroup_0(), "rule__MetaclassReference__Group_0__0");
			builder.put(grammarAccess.getNamedMetaclassReferenceAccess().getGroup(), "rule__NamedMetaclassReference__Group__0");
			builder.put(grammarAccess.getNamedJavaElementReferenceAccess().getGroup(), "rule__NamedJavaElementReference__Group__0");
			builder.put(grammarAccess.getMetaclassEAttributeReferenceAccess().getGroup(), "rule__MetaclassEAttributeReference__Group__0");
			builder.put(grammarAccess.getMetaclassEReferenceReferenceAccess().getGroup(), "rule__MetaclassEReferenceReference__Group__0");
			...
			builder.put(grammarAccess.getReactionsFileAccess().getNamespaceImportsAssignment_0(), "rule__ReactionsFile__NamespaceImportsAssignment_0");
			builder.put(grammarAccess.getReactionsFileAccess().getMetamodelImportsAssignment_1(), "rule__ReactionsFile__MetamodelImportsAssignment_1");
			builder.put(grammarAccess.getReactionsFileAccess().getReactionsSegmentsAssignment_2(), "rule__ReactionsFile__ReactionsSegmentsAssignment_2");
			...
			builder.put(grammarAccess.getReactionsSegmentAccess().getNameAssignment_1(), "rule__ReactionsSegment__NameAssignment_1");
			builder.put(grammarAccess.getReactionsSegmentAccess().getFromMetamodelsAssignment_7(), "rule__ReactionsSegment__FromMetamodelsAssignment_7");
			builder.put(grammarAccess.getReactionsSegmentAccess().getFromMetamodelsAssignment_8_1(), "rule__ReactionsSegment__FromMetamodelsAssignment_8_1");
			builder.put(grammarAccess.getReactionsSegmentAccess().getToMetamodelsAssignment_12(), "rule__ReactionsSegment__ToMetamodelsAssignment_12");
			builder.put(grammarAccess.getReactionsSegmentAccess().getToMetamodelsAssignment_13_1(), "rule__ReactionsSegment__ToMetamodelsAssignment_13_1");
			builder.put(grammarAccess.getReactionsSegmentAccess().getReactionsImportsAssignment_14(), "rule__ReactionsSegment__ReactionsImportsAssignment_14");
			builder.put(grammarAccess.getReactionsSegmentAccess().getReactionsAssignment_15_0(), "rule__ReactionsSegment__ReactionsAssignment_15_0");
			builder.put(grammarAccess.getReactionsSegmentAccess().getRoutinesAssignment_15_1(), "rule__ReactionsSegment__RoutinesAssignment_15_1");
			builder.put(grammarAccess.getReactionsImportAccess().getRoutinesOnlyAssignment_1(), "rule__ReactionsImport__RoutinesOnlyAssignment_1");
			builder.put(grammarAccess.getReactionsImportAccess().getImportedReactionsSegmentAssignment_2(), "rule__ReactionsImport__ImportedReactionsSegmentAssignment_2");
			builder.put(grammarAccess.getReactionsImportAccess().getUseQualifiedNamesAssignment_3_0(), "rule__ReactionsImport__UseQualifiedNamesAssignment_3_0");
			builder.put(grammarAccess.getReactionAccess().getDocumentationAssignment_0(), "rule__Reaction__DocumentationAssignment_0");
			builder.put(grammarAccess.getReactionAccess().getOverriddenReactionsSegmentAssignment_2_0(), "rule__Reaction__OverriddenReactionsSegmentAssignment_2_0");
			builder.put(grammarAccess.getReactionAccess().getNameAssignment_3(), "rule__Reaction__NameAssignment_3");
			builder.put(grammarAccess.getReactionAccess().getTriggerAssignment_5(), "rule__Reaction__TriggerAssignment_5");
			builder.put(grammarAccess.getReactionAccess().getCallRoutineAssignment_6(), "rule__Reaction__CallRoutineAssignment_6");
			builder.put(grammarAccess.getRoutineCallAccess().getCodeAssignment_2(), "rule__RoutineCall__CodeAssignment_2");
			builder.put(grammarAccess.getModelElementChangeAccess().getElementTypeAssignment_2(), "rule__ModelElementChange__ElementTypeAssignment_2");
			builder.put(grammarAccess.getModelElementChangeAccess().getChangeTypeAssignment_3(), "rule__ModelElementChange__ChangeTypeAssignment_3");
			builder.put(grammarAccess.getModelElementChangeAccess().getPreconditionAssignment_4_1(), "rule__ModelElementChange__PreconditionAssignment_4_1");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getFeatureAssignment_2(), "rule__ModelAttributeChange__FeatureAssignment_2");
			builder.put(grammarAccess.getModelAttributeChangeAccess().getPreconditionAssignment_3_1(), "rule__ModelAttributeChange__PreconditionAssignment_3_1");
			builder.put(grammarAccess.getArbitraryModelChangeAccess().getPreconditionAssignment_2_1(), "rule__ArbitraryModelChange__PreconditionAssignment_2_1");
			builder.put(grammarAccess.getElementReferenceChangeTypeAccess().getFeatureAssignment(), "rule__ElementReferenceChangeType__FeatureAssignment");
			builder.put(grammarAccess.getRoutineAccess().getDocumentationAssignment_0(), "rule__Routine__DocumentationAssignment_0");
			builder.put(grammarAccess.getRoutineAccess().getOverrideImportPathAssignment_2_0(), "rule__Routine__OverrideImportPathAssignment_2_0");
			builder.put(grammarAccess.getRoutineAccess().getNameAssignment_3(), "rule__Routine__NameAssignment_3");
			builder.put(grammarAccess.getRoutineAccess().getInputAssignment_4(), "rule__Routine__InputAssignment_4");
			builder.put(grammarAccess.getRoutineAccess().getMatchBlockAssignment_6(), "rule__Routine__MatchBlockAssignment_6");
			builder.put(grammarAccess.getRoutineAccess().getCreateBlockAssignment_7(), "rule__Routine__CreateBlockAssignment_7");
			builder.put(grammarAccess.getRoutineAccess().getUpdateBlockAssignment_8(), "rule__Routine__UpdateBlockAssignment_8");
			builder.put(grammarAccess.getRoutineOverrideImportPathAccess().getReactionsSegmentAssignment_0(), "rule__RoutineOverrideImportPath__ReactionsSegmentAssignment_0");
			builder.put(grammarAccess.getRoutineOverrideImportPathAccess().getReactionsSegmentAssignment_1_2(), "rule__RoutineOverrideImportPath__ReactionsSegmentAssignment_1_2");
			builder.put(grammarAccess.getRoutineInputAccess().getModelInputElementsAssignment_2_0_0(), "rule__RoutineInput__ModelInputElementsAssignment_2_0_0");
			builder.put(grammarAccess.getRoutineInputAccess().getJavaInputElementsAssignment_2_0_1_1(), "rule__RoutineInput__JavaInputElementsAssignment_2_0_1_1");
			builder.put(grammarAccess.getRoutineInputAccess().getModelInputElementsAssignment_2_1_1_0(), "rule__RoutineInput__ModelInputElementsAssignment_2_1_1_0");
			builder.put(grammarAccess.getRoutineInputAccess().getJavaInputElementsAssignment_2_1_1_1_1(), "rule__RoutineInput__JavaInputElementsAssignment_2_1_1_1_1");
			builder.put(grammarAccess.getMatchBlockAccess().getMatchStatementsAssignment_3(), "rule__MatchBlock__MatchStatementsAssignment_3");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getElementTypeAssignment_4(), "rule__RequireAbscenceOfModelElement__ElementTypeAssignment_4");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getCorrespondenceSourceAssignment_7(), "rule__RequireAbscenceOfModelElement__CorrespondenceSourceAssignment_7");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getTagAssignment_8_1(), "rule__RequireAbscenceOfModelElement__TagAssignment_8_1");
			builder.put(grammarAccess.getRequireAbscenceOfModelElementAccess().getPreconditionAssignment_9_1(), "rule__RequireAbscenceOfModelElement__PreconditionAssignment_9_1");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getNameAssignment_1_1(), "rule__RetrieveModelElement__NameAssignment_1_1");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getRetrievalTypeAssignment_3(), "rule__RetrieveModelElement__RetrievalTypeAssignment_3");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getElementTypeAssignment_4(), "rule__RetrieveModelElement__ElementTypeAssignment_4");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getCorrespondenceSourceAssignment_7(), "rule__RetrieveModelElement__CorrespondenceSourceAssignment_7");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getTagAssignment_8_1(), "rule__RetrieveModelElement__TagAssignment_8_1");
			builder.put(grammarAccess.getRetrieveModelElementAccess().getPreconditionAssignment_9_1(), "rule__RetrieveModelElement__PreconditionAssignment_9_1");
			builder.put(grammarAccess.getRetrieveModelElementTypeStatementAccess().getOptionalAssignment_0_1_0(), "rule__RetrieveModelElementTypeStatement__OptionalAssignment_0_1_0");
			builder.put(grammarAccess.getRetrieveModelElementTypeStatementAccess().getAssertedAssignment_0_1_1(), "rule__RetrieveModelElementTypeStatement__AssertedAssignment_0_1_1");
			builder.put(grammarAccess.getMatchCheckStatementAccess().getAssertedAssignment_2(), "rule__MatchCheckStatement__AssertedAssignment_2");
			builder.put(grammarAccess.getMatchCheckStatementAccess().getConditionAssignment_3(), "rule__MatchCheckStatement__ConditionAssignment_3");
			builder.put(grammarAccess.getCreateBlockAccess().getCreateStatementsAssignment_3(), "rule__CreateBlock__CreateStatementsAssignment_3");
			builder.put(grammarAccess.getCreateStatementAccess().getNameAssignment_1(), "rule__CreateStatement__NameAssignment_1");
			builder.put(grammarAccess.getUpdateBlockAccess().getCodeAssignment_1(), "rule__UpdateBlock__CodeAssignment_1");
			builder.put(grammarAccess.getMetaclassReferenceAccess().getMetamodelAssignment_0_0(), "rule__MetaclassReference__MetamodelAssignment_0_0");
			builder.put(grammarAccess.getMetaclassReferenceAccess().getMetaclassAssignment_1(), "rule__MetaclassReference__MetaclassAssignment_1");
			builder.put(grammarAccess.getNamedMetaclassReferenceAccess().getNameAssignment_1(), "rule__NamedMetaclassReference__NameAssignment_1");
			builder.put(grammarAccess.getNamedJavaElementReferenceAccess().getTypeAssignment_0(), "rule__NamedJavaElementReference__TypeAssignment_0");
			builder.put(grammarAccess.getNamedJavaElementReferenceAccess().getNameAssignment_2(), "rule__NamedJavaElementReference__NameAssignment_2");
			builder.put(grammarAccess.getMetaclassEAttributeReferenceAccess().getFeatureAssignment_2(), "rule__MetaclassEAttributeReference__FeatureAssignment_2");
			builder.put(grammarAccess.getMetaclassEReferenceReferenceAccess().getFeatureAssignment_2(), "rule__MetaclassEReferenceReference__FeatureAssignment_2");
