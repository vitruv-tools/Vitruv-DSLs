...
import tools.vitruv.dsls.reactions.ide.contentassist.antlr.PartialReactionsLanguageContentAssistParser;
import tools.vitruv.dsls.reactions.ide.contentassist.antlr.ReactionsLanguageParser;
import tools.vitruv.dsls.reactions.ide.contentassist.antlr.internal.InternalReactionsLanguageLexer;
import tools.vitruv.dsls.reactions.ui.contentassist.ReactionsLanguageProposalProvider;
import tools.vitruv.dsls.reactions.ui.editor.ReactionsLanguageEditor;
import tools.vitruv.dsls.reactions.ui.labeling.ReactionsLanguageDescriptionLabelProvider;
import tools.vitruv.dsls.reactions.ui.labeling.ReactionsLanguageLabelProvider;
import tools.vitruv.dsls.reactions.ui.outline.ReactionsLanguageOutlineTreeProvider;
import tools.vitruv.dsls.reactions.ui.quickfix.ReactionsLanguageQuickfixProvider;

/**
 * Manual modifications go to {@link ReactionsLanguageUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractReactionsLanguageUiModule extends DefaultXbaseUiModule {

	public AbstractReactionsLanguageUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalReactionsLanguageLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(tools.vitruv.dsls.reactions.parser.antlr.internal.InternalReactionsLanguageLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return ReactionsLanguageParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalReactionsLanguageLexer.class).toProvider(LexerProvider.create(InternalReactionsLanguageLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ReactionsLanguageLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ReactionsLanguageDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ReactionsLanguageOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ReactionsLanguageQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ReactionsLanguageProposalProvider.class;
	}
	...
	public Class<? extends XtextEditor> bindXtextEditor() {
		return ReactionsLanguageEditor.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialReactionsLanguageContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("ReactionsLanguage Compare");
	}
