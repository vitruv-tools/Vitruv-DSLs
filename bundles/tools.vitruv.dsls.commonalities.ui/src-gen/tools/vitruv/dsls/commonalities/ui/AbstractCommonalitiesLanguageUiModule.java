...
import tools.vitruv.dsls.commonalities.ide.contentassist.antlr.CommonalitiesLanguageParser;
import tools.vitruv.dsls.commonalities.ide.contentassist.antlr.PartialCommonalitiesLanguageContentAssistParser;
import tools.vitruv.dsls.commonalities.ide.contentassist.antlr.internal.InternalCommonalitiesLanguageLexer;
import tools.vitruv.dsls.commonalities.ui.contentassist.CommonalitiesLanguageProposalProvider;
import tools.vitruv.dsls.commonalities.ui.editor.CommonalitiesLanguageEditor;
import tools.vitruv.dsls.commonalities.ui.labeling.CommonalitiesLanguageDescriptionLabelProvider;
import tools.vitruv.dsls.commonalities.ui.labeling.CommonalitiesLanguageLabelProvider;
import tools.vitruv.dsls.commonalities.ui.outline.CommonalitiesLanguageOutlineTreeProvider;
import tools.vitruv.dsls.commonalities.ui.quickfix.CommonalitiesLanguageQuickfixProvider;

/**
 * Manual modifications go to {@link CommonalitiesLanguageUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractCommonalitiesLanguageUiModule extends DefaultXbaseUiModule {

	public AbstractCommonalitiesLanguageUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalCommonalitiesLanguageLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(tools.vitruv.dsls.commonalities.parser.antlr.internal.InternalCommonalitiesLanguageLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return CommonalitiesLanguageParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalCommonalitiesLanguageLexer.class).toProvider(LexerProvider.create(InternalCommonalitiesLanguageLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return CommonalitiesLanguageLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(CommonalitiesLanguageDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return CommonalitiesLanguageOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return CommonalitiesLanguageQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return CommonalitiesLanguageProposalProvider.class;
	}
	...
	public Class<? extends XtextEditor> bindXtextEditor() {
		return CommonalitiesLanguageEditor.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialCommonalitiesLanguageContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("CommonalitiesLanguage Compare");
	}
