 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.common.elements.impl.NamedMetaclassReferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedMetaclassReferenceImpl extends MetaclassReferenceImpl implements NamedMetaclassReference
{
	...
	{
		return ElementsPackage.Literals.NAMED_METACLASS_REFERENCE;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElementsPackage.NAMED_METACLASS_REFERENCE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ElementsPackage.NAMED_METACLASS_REFERENCE__NAME:
				return getName();
		}
