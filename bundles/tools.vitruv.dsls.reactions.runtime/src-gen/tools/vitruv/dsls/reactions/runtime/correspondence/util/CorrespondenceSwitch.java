/**
 */
package tools.vitruv.dsls.reactions.runtime.correspondence.util;
...
public class CorrespondenceSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case CorrespondencePackage.REACTIONS_CORRESPONDENCE:
			{
				ReactionsCorrespondence reactionsCorrespondence = (ReactionsCorrespondence)theEObject;
				T result = caseReactionsCorrespondence(reactionsCorrespondence);
				if (result == null) result = caseCorrespondence(reactionsCorrespondence);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reactions Correspondence</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reactions Correspondence</em>'.
