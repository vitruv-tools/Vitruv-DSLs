...
public final class ReactionsCorrespondenceModelViewFactory
	...
	@Override
	public CorrespondenceModelView<ReactionsCorrespondence> createCorrespondenceModelView(InternalCorrespondenceModel correspondenceModel) {
		return new CorrespondenceModelViewImpl<ReactionsCorrespondence>(ReactionsCorrespondence.class, correspondenceModel, null);
	}

	@Override
	public CorrespondenceModelView<ReactionsCorrespondence> createEditableCorrespondenceModelView(InternalCorrespondenceModel correspondenceModel) {
		return new CorrespondenceModelViewImpl<ReactionsCorrespondence>(ReactionsCorrespondence.class, correspondenceModel,
