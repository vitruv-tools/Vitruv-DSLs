...
public class DeleteFamilyIfEmptyRoutine extends AbstractRoutine {
  ...
  private static class Match extends AbstractRoutine.Match {
    ...
    public DeleteFamilyIfEmptyRoutine.Match.RetrievedValues match(final Family family) throws IOException {
      ...
      return new mir.routines.familiesToPersons.DeleteFamilyIfEmptyRoutine.Match.RetrievedValues();
    }
  }
  ...
  private static class Update extends AbstractRoutine.Update {
    ...
    public void updateModels(final Family family, @Extension final FamiliesToPersonsRoutinesFacade _routinesFacade) {
      FamiliesUtil.getRegister(family).getFamilies().remove(family);
    }
  }

  public DeleteFamilyIfEmptyRoutine(final FamiliesToPersonsRoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Family family) {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    retrievedValues = new mir.routines.familiesToPersons.DeleteFamilyIfEmptyRoutine.Match(getExecutionState()).match(inputValues.family);
    if (retrievedValues == null) {
    	return false;
    }
    // This execution step is empty
    new mir.routines.familiesToPersons.DeleteFamilyIfEmptyRoutine.Update(getExecutionState()).updateModels(inputValues.family, getRoutinesFacade());
    return true;
  }
}
