...
public class DeletePersonReaction extends AbstractReaction {
  private DeleteEObject<Person> deleteChange;

  public DeletePersonReaction(final Function<ReactionExecutionState, RoutinesFacade> routinesFacadeGenerator) {
  ...
  private static class Call extends AbstractRoutine.Update {
    ...
    public void updateModels(final DeleteEObject deleteChange, final Person affectedEObject, @Extension final PersonsToFamiliesRoutinesFacade _routinesFacade) {
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.personsToFamilies.DeletePersonReaction.Call(executionState).updateModels(deleteChange, affectedEObject, routinesFacade);
  }
}
