...
public class DeletedFamilyRegisterReaction extends AbstractReaction {
  ...
  private static class Call extends AbstractRoutine.Update {
    ...
    public void updateModels(final DeleteEObject deleteChange, final FamilyRegister affectedEObject, @Extension final FamiliesToPersonsRoutinesFacade _routinesFacade) {
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.familiesToPersons.DeletedFamilyRegisterReaction.Call(executionState).updateModels(deleteChange, affectedEObject, routinesFacade);
  }
}
