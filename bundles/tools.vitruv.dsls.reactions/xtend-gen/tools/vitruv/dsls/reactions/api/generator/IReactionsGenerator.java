...
public interface IReactionsGenerator {
   ...
   */
  void addReaction(final String sourceFileName, final Reaction... reactions);
   ...
   * 		The reaction to add for generation.
   */
  void addReaction(final String sourceFileName, final Iterable<? extends Reaction> reactions);
   ...
   */
  void addReactionsFile(final FluentReactionsFileBuilder reactionBuilder);
   ...
   * 		generation.
   */
  void addReactionsFile(final String sourceFileName, final ReactionsFile reactionsFile);
   ...
   */
  void addReactionsFiles(final XtextResourceSet resourceSet);
   ...
   */
  void useResourceSet(final ResourceSet resourceSet);
   ...
   */
  void generate(final IFileSystemAccess2 fsa);
   ...
   * 		be written to the root of the default output configuration.
   */
  void writeReactions(final IFileSystemAccess2 fsa) throws IOException;
   ...
   */
  void writeReactions(final IFileSystemAccess2 fsa, final String subPath) throws IOException;
}
