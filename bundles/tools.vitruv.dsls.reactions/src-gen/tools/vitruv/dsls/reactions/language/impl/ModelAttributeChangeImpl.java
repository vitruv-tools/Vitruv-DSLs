 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ModelAttributeChangeImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelAttributeChangeImpl extends ConcreteModelChangeImpl implements ModelAttributeChange
{
  ...
  {
    return LanguagePackage.Literals.MODEL_ATTRIBUTE_CHANGE;
  }
  ...
  public NotificationChain basicSetFeature(MetaclassEAttributeReference newFeature, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.MODEL_ATTRIBUTE_CHANGE__FEATURE, oldFeature, newFeature);
  ...
  public void setFeature(MetaclassEAttributeReference newFeature)
  {
    if (newFeature != feature)
    {
      ...
      if (feature != null)
        msgs = ((InternalEObject)feature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.MODEL_ATTRIBUTE_CHANGE__FEATURE, null, msgs);
      if (newFeature != null)
        msgs = ((InternalEObject)newFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.MODEL_ATTRIBUTE_CHANGE__FEATURE, null, msgs);
      msgs = basicSetFeature(newFeature, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.MODEL_ATTRIBUTE_CHANGE__FEATURE, newFeature, newFeature));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LanguagePackage.MODEL_ATTRIBUTE_CHANGE__FEATURE:
