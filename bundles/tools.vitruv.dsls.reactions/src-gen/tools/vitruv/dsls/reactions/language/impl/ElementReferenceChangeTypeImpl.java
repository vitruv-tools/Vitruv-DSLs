 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ElementReferenceChangeTypeImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementReferenceChangeTypeImpl extends MinimalEObjectImpl.Container implements ElementReferenceChangeType
{
  ...
  {
    return LanguagePackage.Literals.ELEMENT_REFERENCE_CHANGE_TYPE;
  }
  ...
  public NotificationChain basicSetFeature(MetaclassEReferenceReference newFeature, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_REFERENCE_CHANGE_TYPE__FEATURE, oldFeature, newFeature);
  ...
  public void setFeature(MetaclassEReferenceReference newFeature)
  {
    if (newFeature != feature)
    {
      ...
      if (feature != null)
        msgs = ((InternalEObject)feature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_REFERENCE_CHANGE_TYPE__FEATURE, null, msgs);
      if (newFeature != null)
        msgs = ((InternalEObject)newFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_REFERENCE_CHANGE_TYPE__FEATURE, null, msgs);
      msgs = basicSetFeature(newFeature, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_REFERENCE_CHANGE_TYPE__FEATURE, newFeature, newFeature));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LanguagePackage.ELEMENT_REFERENCE_CHANGE_TYPE__FEATURE:
