...
public class InputTypesFactoryImpl extends EFactoryImpl implements InputTypesFactory
{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.String createString()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Integer createInteger()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Short createShort()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Boolean createBoolean()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Long createLong()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Character createCharacter()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Byte createByte()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Float createFloat()
	{
	 ...
	 */
	@Override
	public tools.vitruv.dsls.reactions.language.inputTypes.Double createDouble()
	{
