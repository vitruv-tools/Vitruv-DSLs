 ...
 */
package tools.vitruv.dsls.commonalities.ide.contentassist.antlr;
...
import tools.vitruv.dsls.commonalities.ide.contentassist.antlr.internal.InternalCommonalitiesLanguageParser;
import tools.vitruv.dsls.commonalities.services.CommonalitiesLanguageGrammarAccess;

public class CommonalitiesLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CommonalitiesLanguageGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CommonalitiesLanguageGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getOperatorImportAccess().getAlternatives_1(), "rule__OperatorImport__Alternatives_1");
			builder.put(grammarAccess.getCommonalityAccess().getAlternatives_5(), "rule__Commonality__Alternatives_5");
			builder.put(grammarAccess.getParticipationAccess().getAlternatives_1(), "rule__Participation__Alternatives_1");
			builder.put(grammarAccess.getParticipationAccess().getAlternatives_3(), "rule__Participation__Alternatives_3");
			builder.put(grammarAccess.getParticipationClassAccess().getAlternatives(), "rule__ParticipationClass__Alternatives");
			builder.put(grammarAccess.getParticipationPartAccess().getAlternatives(), "rule__ParticipationPart__Alternatives");
			builder.put(grammarAccess.getParticipationRelationAccess().getAlternatives_0(), "rule__ParticipationRelation__Alternatives_0");
			builder.put(grammarAccess.getParticipationRelationAccess().getAlternatives_2(), "rule__ParticipationRelation__Alternatives_2");
			builder.put(grammarAccess.getParticipationConditionAccess().getAlternatives_0(), "rule__ParticipationCondition__Alternatives_0");
			builder.put(grammarAccess.getParticipationConditionAccess().getAlternatives_3(), "rule__ParticipationCondition__Alternatives_3");
			builder.put(grammarAccess.getParticipationConditionLeftOperandAccess().getAlternatives(), "rule__ParticipationConditionLeftOperand__Alternatives");
			builder.put(grammarAccess.getParticipationConditionRightOperandAccess().getAlternatives(), "rule__ParticipationConditionRightOperand__Alternatives");
			builder.put(grammarAccess.getParticipationConditionOperandAccess().getAlternatives(), "rule__ParticipationConditionOperand__Alternatives");
			builder.put(grammarAccess.getAttributeAccess().getAlternatives(), "rule__Attribute__Alternatives");
			builder.put(grammarAccess.getCommonalityAttributeMappingAccess().getAlternatives(), "rule__CommonalityAttributeMapping__Alternatives");
			builder.put(grammarAccess.getSimpleAttributeMappingAccess().getAlternatives_0(), "rule__SimpleAttributeMapping__Alternatives_0");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getAlternatives_0(), "rule__OperatorAttributeMapping__Alternatives_0");
			builder.put(grammarAccess.getAttributeMappingOperandAccess().getAlternatives(), "rule__AttributeMappingOperand__Alternatives");
			builder.put(grammarAccess.getParticipationAttributeAccess().getAlternatives(), "rule__ParticipationAttribute__Alternatives");
			builder.put(grammarAccess.getCommonalityReferenceMappingAccess().getAlternatives(), "rule__CommonalityReferenceMapping__Alternatives");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getAlternatives_0(), "rule__SimpleReferenceMapping__Alternatives_0");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getAlternatives_0(), "rule__OperatorReferenceMapping__Alternatives_0");
			builder.put(grammarAccess.getReferenceMappingOperandAccess().getAlternatives(), "rule__ReferenceMappingOperand__Alternatives");
			builder.put(grammarAccess.getOperandAccess().getAlternatives(), "rule__Operand__Alternatives");
			builder.put(grammarAccess.getLiteralOperandAccess().getExpressionAlternatives_0(), "rule__LiteralOperand__ExpressionAlternatives_0");
			builder.put(grammarAccess.getOperatorNameAccess().getAlternatives(), "rule__OperatorName__Alternatives");
			builder.put(grammarAccess.getOperatorNameAccess().getAlternatives_1(), "rule__OperatorName__Alternatives_1");
			...
			builder.put(grammarAccess.getCommonalityFileAccess().getGroup(), "rule__CommonalityFile__Group__0");
			builder.put(grammarAccess.getOperatorImportAccess().getGroup(), "rule__OperatorImport__Group__0");
			builder.put(grammarAccess.getMetamodelImportAccess().getGroup(), "rule__MetamodelImport__Group__0");
			builder.put(grammarAccess.getMetamodelImportAccess().getGroup_4(), "rule__MetamodelImport__Group_4__0");
			...
			builder.put(grammarAccess.getParticipationAccess().getGroup(), "rule__Participation__Group__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_1_1(), "rule__Participation__Group_1_1__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_1_1_2(), "rule__Participation__Group_1_1_2__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_3_1(), "rule__Participation__Group_3_1__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_3_1_2(), "rule__Participation__Group_3_1_2__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_4(), "rule__Participation__Group_4__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_4_2(), "rule__Participation__Group_4_2__0");
			builder.put(grammarAccess.getParticipationAccess().getGroup_4_2_1(), "rule__Participation__Group_4_2_1__0");
			builder.put(grammarAccess.getFullParticipationClassAccess().getGroup(), "rule__FullParticipationClass__Group__0");
			builder.put(grammarAccess.getFullParticipationClassAccess().getGroup_3(), "rule__FullParticipationClass__Group_3__0");
			builder.put(grammarAccess.getParticipationPartAccess().getGroup_1(), "rule__ParticipationPart__Group_1__0");
			builder.put(grammarAccess.getParticipationRelationAccess().getGroup(), "rule__ParticipationRelation__Group__0");
			builder.put(grammarAccess.getParticipationRelationAccess().getGroup_0_1(), "rule__ParticipationRelation__Group_0_1__0");
			builder.put(grammarAccess.getParticipationRelationAccess().getGroup_0_1_2(), "rule__ParticipationRelation__Group_0_1_2__0");
			builder.put(grammarAccess.getParticipationRelationAccess().getGroup_2_1(), "rule__ParticipationRelation__Group_2_1__0");
			builder.put(grammarAccess.getParticipationRelationAccess().getGroup_2_1_2(), "rule__ParticipationRelation__Group_2_1_2__0");
			builder.put(grammarAccess.getParticipationConditionAccess().getGroup(), "rule__ParticipationCondition__Group__0");
			builder.put(grammarAccess.getParticipationConditionAccess().getGroup_0_1(), "rule__ParticipationCondition__Group_0_1__0");
			builder.put(grammarAccess.getParticipationConditionAccess().getGroup_0_2(), "rule__ParticipationCondition__Group_0_2__0");
			builder.put(grammarAccess.getParticipationConditionAccess().getGroup_3_1(), "rule__ParticipationCondition__Group_3_1__0");
			builder.put(grammarAccess.getParticipationConditionAccess().getGroup_3_1_1(), "rule__ParticipationCondition__Group_3_1_1__0");
			builder.put(grammarAccess.getParticipationConditionAccess().getGroup_3_1_1_1(), "rule__ParticipationCondition__Group_3_1_1_1__0");
			builder.put(grammarAccess.getCommonalityAttributeAccess().getGroup(), "rule__CommonalityAttribute__Group__0");
			builder.put(grammarAccess.getSimpleAttributeMappingAccess().getGroup(), "rule__SimpleAttributeMapping__Group__0");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getGroup(), "rule__OperatorAttributeMapping__Group__0");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getGroup_3(), "rule__OperatorAttributeMapping__Group_3__0");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getGroup_3_1(), "rule__OperatorAttributeMapping__Group_3_1__0");
			builder.put(grammarAccess.getQualifiedParticipationAttributeAccess().getGroup(), "rule__QualifiedParticipationAttribute__Group__0");
			builder.put(grammarAccess.getUnqualifiedParticipationAttributeAccess().getGroup(), "rule__UnqualifiedParticipationAttribute__Group__0");
			builder.put(grammarAccess.getLocalUnqualifiedCommonalityAttributeReferenceAccess().getGroup(), "rule__LocalUnqualifiedCommonalityAttributeReference__Group__0");
			builder.put(grammarAccess.getCommonalityReferenceAccess().getGroup(), "rule__CommonalityReference__Group__0");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getGroup(), "rule__SimpleReferenceMapping__Group__0");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getGroup_2(), "rule__SimpleReferenceMapping__Group_2__0");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getGroup_2_2(), "rule__SimpleReferenceMapping__Group_2_2__0");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getGroup(), "rule__OperatorReferenceMapping__Group__0");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getGroup_5(), "rule__OperatorReferenceMapping__Group_5__0");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getGroup_5_1(), "rule__OperatorReferenceMapping__Group_5_1__0");
			builder.put(grammarAccess.getReferencedParticipationAttributeOperandAccess().getGroup(), "rule__ReferencedParticipationAttributeOperand__Group__0");
			builder.put(grammarAccess.getQualifiedClassAccess().getGroup(), "rule__QualifiedClass__Group__0");
			builder.put(grammarAccess.getQualifiedOperatorNameAccess().getGroup(), "rule__QualifiedOperatorName__Group__0");
			builder.put(grammarAccess.getQualifiedOperatorNameAccess().getGroup_1(), "rule__QualifiedOperatorName__Group_1__0");
			builder.put(grammarAccess.getQualifiedOperatorWildCardAccess().getGroup(), "rule__QualifiedOperatorWildCard__Group__0");
			builder.put(grammarAccess.getQualifiedOperatorWildCardAccess().getGroup_1(), "rule__QualifiedOperatorWildCard__Group_1__0");
			...
			builder.put(grammarAccess.getCommonalityFileAccess().getOperatorImportsAssignment_0(), "rule__CommonalityFile__OperatorImportsAssignment_0");
			builder.put(grammarAccess.getCommonalityFileAccess().getMetamodelImportsAssignment_1(), "rule__CommonalityFile__MetamodelImportsAssignment_1");
			builder.put(grammarAccess.getCommonalityFileAccess().getConceptAssignment_2(), "rule__CommonalityFile__ConceptAssignment_2");
			builder.put(grammarAccess.getCommonalityFileAccess().getCommonalityAssignment_3(), "rule__CommonalityFile__CommonalityAssignment_3");
			builder.put(grammarAccess.getOperatorImportAccess().getImportedNamespaceAssignment_1_0(), "rule__OperatorImport__ImportedNamespaceAssignment_1_0");
			builder.put(grammarAccess.getOperatorImportAccess().getImportedNamespaceAssignment_1_1(), "rule__OperatorImport__ImportedNamespaceAssignment_1_1");
			builder.put(grammarAccess.getMetamodelImportAccess().getPackageAssignment_1(), "rule__MetamodelImport__PackageAssignment_1");
			builder.put(grammarAccess.getMetamodelImportAccess().getNameAssignment_3(), "rule__MetamodelImport__NameAssignment_3");
			builder.put(grammarAccess.getMetamodelImportAccess().getUseQualifiedNamesAssignment_4_0(), "rule__MetamodelImport__UseQualifiedNamesAssignment_4_0");
			builder.put(grammarAccess.getConceptAccess().getNameAssignment_1(), "rule__Concept__NameAssignment_1");
			builder.put(grammarAccess.getCommonalityAccess().getReferencedAssignment_0(), "rule__Commonality__ReferencedAssignment_0");
			builder.put(grammarAccess.getCommonalityAccess().getNameAssignment_2(), "rule__Commonality__NameAssignment_2");
			builder.put(grammarAccess.getCommonalityAccess().getParticipationsAssignment_4(), "rule__Commonality__ParticipationsAssignment_4");
			builder.put(grammarAccess.getCommonalityAccess().getAttributesAssignment_5_0(), "rule__Commonality__AttributesAssignment_5_0");
			builder.put(grammarAccess.getCommonalityAccess().getReferencesAssignment_5_1(), "rule__Commonality__ReferencesAssignment_5_1");
			builder.put(grammarAccess.getParticipationAccess().getDomainNameAssignment_1_0(), "rule__Participation__DomainNameAssignment_1_0");
			builder.put(grammarAccess.getParticipationAccess().getDomainNameAssignment_1_1_1(), "rule__Participation__DomainNameAssignment_1_1_1");
			builder.put(grammarAccess.getParticipationAccess().getDomainAliasAssignment_1_1_2_1(), "rule__Participation__DomainAliasAssignment_1_1_2_1");
			builder.put(grammarAccess.getParticipationAccess().getPartsAssignment_3_0(), "rule__Participation__PartsAssignment_3_0");
			builder.put(grammarAccess.getParticipationAccess().getPartsAssignment_3_1_1(), "rule__Participation__PartsAssignment_3_1_1");
			builder.put(grammarAccess.getParticipationAccess().getPartsAssignment_3_1_2_1(), "rule__Participation__PartsAssignment_3_1_2_1");
			builder.put(grammarAccess.getParticipationAccess().getConditionsAssignment_4_2_0(), "rule__Participation__ConditionsAssignment_4_2_0");
			builder.put(grammarAccess.getParticipationAccess().getConditionsAssignment_4_2_1_1(), "rule__Participation__ConditionsAssignment_4_2_1_1");
			builder.put(grammarAccess.getSimpleParticipationClassAccess().getSuperMetaclassAssignment(), "rule__SimpleParticipationClass__SuperMetaclassAssignment");
			builder.put(grammarAccess.getFullParticipationClassAccess().getSingletonAssignment_1(), "rule__FullParticipationClass__SingletonAssignment_1");
			builder.put(grammarAccess.getFullParticipationClassAccess().getSuperMetaclassAssignment_2(), "rule__FullParticipationClass__SuperMetaclassAssignment_2");
			builder.put(grammarAccess.getFullParticipationClassAccess().getClassAliasAssignment_3_1(), "rule__FullParticipationClass__ClassAliasAssignment_3_1");
			builder.put(grammarAccess.getParticipationRelationAccess().getLeftPartsAssignment_0_0(), "rule__ParticipationRelation__LeftPartsAssignment_0_0");
			builder.put(grammarAccess.getParticipationRelationAccess().getLeftPartsAssignment_0_1_1(), "rule__ParticipationRelation__LeftPartsAssignment_0_1_1");
			builder.put(grammarAccess.getParticipationRelationAccess().getLeftPartsAssignment_0_1_2_1(), "rule__ParticipationRelation__LeftPartsAssignment_0_1_2_1");
			builder.put(grammarAccess.getParticipationRelationAccess().getOperatorAssignment_1(), "rule__ParticipationRelation__OperatorAssignment_1");
			builder.put(grammarAccess.getParticipationRelationAccess().getRightPartsAssignment_2_0(), "rule__ParticipationRelation__RightPartsAssignment_2_0");
			builder.put(grammarAccess.getParticipationRelationAccess().getRightPartsAssignment_2_1_1(), "rule__ParticipationRelation__RightPartsAssignment_2_1_1");
			builder.put(grammarAccess.getParticipationRelationAccess().getRightPartsAssignment_2_1_2_1(), "rule__ParticipationRelation__RightPartsAssignment_2_1_2_1");
			builder.put(grammarAccess.getParticipationConditionAccess().getLeftOperandAssignment_1(), "rule__ParticipationCondition__LeftOperandAssignment_1");
			builder.put(grammarAccess.getParticipationConditionAccess().getOperatorAssignment_2(), "rule__ParticipationCondition__OperatorAssignment_2");
			builder.put(grammarAccess.getParticipationConditionAccess().getRightOperandsAssignment_3_0(), "rule__ParticipationCondition__RightOperandsAssignment_3_0");
			builder.put(grammarAccess.getParticipationConditionAccess().getRightOperandsAssignment_3_1_1_0(), "rule__ParticipationCondition__RightOperandsAssignment_3_1_1_0");
			builder.put(grammarAccess.getParticipationConditionAccess().getRightOperandsAssignment_3_1_1_1_1(), "rule__ParticipationCondition__RightOperandsAssignment_3_1_1_1_1");
			builder.put(grammarAccess.getCommonalityAttributeAccess().getNameAssignment_1(), "rule__CommonalityAttribute__NameAssignment_1");
			builder.put(grammarAccess.getCommonalityAttributeAccess().getMappingsAssignment_3(), "rule__CommonalityAttribute__MappingsAssignment_3");
			builder.put(grammarAccess.getSimpleAttributeMappingAccess().getReadAndWriteAssignment_0_0(), "rule__SimpleAttributeMapping__ReadAndWriteAssignment_0_0");
			builder.put(grammarAccess.getSimpleAttributeMappingAccess().getWriteAssignment_0_1(), "rule__SimpleAttributeMapping__WriteAssignment_0_1");
			builder.put(grammarAccess.getSimpleAttributeMappingAccess().getReadAssignment_0_2(), "rule__SimpleAttributeMapping__ReadAssignment_0_2");
			builder.put(grammarAccess.getSimpleAttributeMappingAccess().getAttributeAssignment_1(), "rule__SimpleAttributeMapping__AttributeAssignment_1");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getReadAndWriteAssignment_0_0(), "rule__OperatorAttributeMapping__ReadAndWriteAssignment_0_0");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getWriteAssignment_0_1(), "rule__OperatorAttributeMapping__WriteAssignment_0_1");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getReadAssignment_0_2(), "rule__OperatorAttributeMapping__ReadAssignment_0_2");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getOperatorAssignment_1(), "rule__OperatorAttributeMapping__OperatorAssignment_1");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getOperandsAssignment_3_0(), "rule__OperatorAttributeMapping__OperandsAssignment_3_0");
			builder.put(grammarAccess.getOperatorAttributeMappingAccess().getOperandsAssignment_3_1_1(), "rule__OperatorAttributeMapping__OperandsAssignment_3_1_1");
			builder.put(grammarAccess.getQualifiedParticipationAttributeAccess().getParticipationClassAssignment_0(), "rule__QualifiedParticipationAttribute__ParticipationClassAssignment_0");
			builder.put(grammarAccess.getQualifiedParticipationAttributeAccess().getAttributeAssignment_2(), "rule__QualifiedParticipationAttribute__AttributeAssignment_2");
			builder.put(grammarAccess.getUnqualifiedParticipationAttributeAccess().getParticipationClassAssignment_0(), "rule__UnqualifiedParticipationAttribute__ParticipationClassAssignment_0");
			builder.put(grammarAccess.getUnqualifiedParticipationAttributeAccess().getAttributeAssignment_2(), "rule__UnqualifiedParticipationAttribute__AttributeAssignment_2");
			builder.put(grammarAccess.getLocalUnqualifiedCommonalityAttributeReferenceAccess().getCommonalityAssignment_0(), "rule__LocalUnqualifiedCommonalityAttributeReference__CommonalityAssignment_0");
			builder.put(grammarAccess.getLocalUnqualifiedCommonalityAttributeReferenceAccess().getAttributeAssignment_2(), "rule__LocalUnqualifiedCommonalityAttributeReference__AttributeAssignment_2");
			builder.put(grammarAccess.getCommonalityReferenceAccess().getNameAssignment_1(), "rule__CommonalityReference__NameAssignment_1");
			builder.put(grammarAccess.getCommonalityReferenceAccess().getReferenceTypeAssignment_3(), "rule__CommonalityReference__ReferenceTypeAssignment_3");
			builder.put(grammarAccess.getCommonalityReferenceAccess().getMappingsAssignment_5(), "rule__CommonalityReference__MappingsAssignment_5");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getReadAndWriteAssignment_0_0(), "rule__SimpleReferenceMapping__ReadAndWriteAssignment_0_0");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getWriteAssignment_0_1(), "rule__SimpleReferenceMapping__WriteAssignment_0_1");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getReadAssignment_0_2(), "rule__SimpleReferenceMapping__ReadAssignment_0_2");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getReferenceAssignment_1(), "rule__SimpleReferenceMapping__ReferenceAssignment_1");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getReferenceTargetsAssignment_2_1(), "rule__SimpleReferenceMapping__ReferenceTargetsAssignment_2_1");
			builder.put(grammarAccess.getSimpleReferenceMappingAccess().getReferenceTargetsAssignment_2_2_1(), "rule__SimpleReferenceMapping__ReferenceTargetsAssignment_2_2_1");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getReadAndWriteAssignment_0_0(), "rule__OperatorReferenceMapping__ReadAndWriteAssignment_0_0");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getWriteAssignment_0_1(), "rule__OperatorReferenceMapping__WriteAssignment_0_1");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getReadAssignment_0_2(), "rule__OperatorReferenceMapping__ReadAssignment_0_2");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getParticipationClassAssignment_1(), "rule__OperatorReferenceMapping__ParticipationClassAssignment_1");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getOperatorAssignment_3(), "rule__OperatorReferenceMapping__OperatorAssignment_3");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getOperandsAssignment_5_0(), "rule__OperatorReferenceMapping__OperandsAssignment_5_0");
			builder.put(grammarAccess.getOperatorReferenceMappingAccess().getOperandsAssignment_5_1_1(), "rule__OperatorReferenceMapping__OperandsAssignment_5_1_1");
			builder.put(grammarAccess.getReferencedParticipationAttributeOperandAccess().getParticipationAttributeAssignment_1(), "rule__ReferencedParticipationAttributeOperand__ParticipationAttributeAssignment_1");
			builder.put(grammarAccess.getLiteralOperandAccess().getExpressionAssignment(), "rule__LiteralOperand__ExpressionAssignment");
			builder.put(grammarAccess.getQualifiedParticipationClassOperandAccess().getParticipationClassAssignment(), "rule__QualifiedParticipationClassOperand__ParticipationClassAssignment");
			builder.put(grammarAccess.getUnqualifiedParticipationClassOperandAccess().getParticipationClassAssignment(), "rule__UnqualifiedParticipationClassOperand__ParticipationClassAssignment");
			builder.put(grammarAccess.getQualifiedParticipationAttributeOperandAccess().getParticipationAttributeAssignment(), "rule__QualifiedParticipationAttributeOperand__ParticipationAttributeAssignment");
			builder.put(grammarAccess.getUnqualifiedParticipationAttributeOperandAccess().getParticipationAttributeAssignment(), "rule__UnqualifiedParticipationAttributeOperand__ParticipationAttributeAssignment");
			builder.put(grammarAccess.getLocalUnqualifiedCommonalityAttributeOperandAccess().getAttributeReferenceAssignment(), "rule__LocalUnqualifiedCommonalityAttributeOperand__AttributeReferenceAssignment");
	...
	@Override
	protected InternalCommonalitiesLanguageParser createParser() {
		InternalCommonalitiesLanguageParser result = new InternalCommonalitiesLanguageParser(null);
