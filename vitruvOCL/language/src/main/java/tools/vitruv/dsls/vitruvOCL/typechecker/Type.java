 ...
 * - Primitive types (INTEGER, STRING, BOOLEAN) have implicit SINGLETON multiplicity
...
public abstract class Type {
     ...
     * 
     * For explicit singleton wrapping (usually not needed as primitives are already singletons)
     * 
 ...
 * 
 * Used in type inference for expressions with multiple branches (e.g., if-then-else).
 * 
 * @param t1 First type
