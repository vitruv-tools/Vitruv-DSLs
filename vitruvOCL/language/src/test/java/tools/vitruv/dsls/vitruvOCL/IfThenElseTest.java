 ...
 * 
 * Tests both type checking and evaluation of conditional expressions.
 */
...
public void testNestedIfThenElse_InCondition_Debug() {
    ...
    public void testDeeplyNestedIfThenElse() {
        String input = "if true then (if false then 1 else (if true then 2 else 3 endif) endif) else 4 endif";
        Value result = compile(input);
    ...
    public void testDeeplyNestedIfThenElse_AllFalse() {
        String input = "if false then 1 else (if false then 2 else (if false then 3 else 4 endif) endif) endif";
        Value result = compile(input);
