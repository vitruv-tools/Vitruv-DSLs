...
public class VitruvOCLParserTestUtils {
  ...
  private static ParseTree parse(CharStream cs) {
    // Debug: Uncomment to see input string
    // System.out.println("INPUT STRING: " + cs.toString());

    VitruvOCLLexer lexer = new VitruvOCLLexer(cs);
    CommonTokenStream tokens = new CommonTokenStream(lexer);

    // Debug: Uncomment to see tokens generated by lexer
    // tokens.fill();
    // System.out.println("TOKENS:");
    // for (Token t : tokens.getTokens()) {
    //     System.out.println(t.getText() + " [" + t.getType() + "]");
    ...
    // Debug: Uncomment to trace parser invocation
    // System.out.println("Calling parser.contextDeclCS()...");

    ParseTree tree = parser.contextDeclCS();

    // Debug: Uncomment to see parse tree structure
    // System.out.println("PARSE TREE: " + tree);
    // System.out.println("TREE OBJECT: " + tree.toStringTree(parser));
   ...
   *
   * <pre>{@code
   * ParseTree tree = parseString("context X::Y inv: self.z > 0");
   * String treeString = treeToString(tree, parser);
   ...
   *
   * <ul>
   *   <li>Verify parser produces expected tree structure
   *   <li>Debug grammar ambiguities or unexpected parses
   *   <li>Document expected parse results in test output
   *   <li>Compare parse trees across different inputs
   * </ul>
   *
